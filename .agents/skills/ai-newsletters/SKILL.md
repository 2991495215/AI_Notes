---
name: AI通讯
description: Curate AI newsletter content with smart deduplication and ranking. Use when user invokes /AI通讯 or when /start-my-day needs newsletter content.
---
