---
name: AI产品
description: Curate AI product launches from Product Hunt, Hacker News, GitHub, and Techmeme. Use when user invokes /AI产品 or when /start-my-day needs product launches.
---
